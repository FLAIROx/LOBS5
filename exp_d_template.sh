#!/bin/bash
#SBATCH --job-name=exp-d-N_PERT_VAL
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --mem=0
#SBATCH --time=01:00:00
#SBATCH --output=logs/exp_d_N_PERT_VAL_%j.out
#SBATCH --error=logs/exp_d_N_PERT_VAL_%j.err
#SBATCH --partition=workq

set -e
echo "============================================================"
echo "Experiment D: n_perturbations=N_PERT_VAL"
echo "============================================================"
...
class Config:
    ...
    task_size: int = 500
    tick_size: int = 100
    checkpoint_dir: str = '/tmp/exp_d_N_PERT_VAL'
    checkpoint_every: int = 9999
    seed: int = 42
    output_dir: str = '/tmp/exp_d_N_PERT_VAL'

print(f'JAX devices: {jax.devices()}')
print(f'Config: n_perturbations=N_PERT_VAL, n_steps=10, background_msgs_per_step=10')
...
print()
print('============================================================')
print('RESULT: n_perturbations=N_PERT_VAL')
print('============================================================')
...
echo ""
echo "Experiment D N_PERT_VAL Complete! End: $(date)"
