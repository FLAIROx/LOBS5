...
class LOBMAXConfig:
    ...
    attention_type: str = "global"  # AttentionType enum value: "global", "local_sliding", "chunk", "mla"
    sliding_window_size: int = 0    # Sliding window size (0=disabled, >0 for local attention)
    ...
    # === Quantization ===
    quantization: str = ""  # "", "fp8", "int8", "te_fp8_delayedscaling", "te_fp8_currentscaling"
    ...
    # === Context Parallelism / Packing (for TE cudnn_flash_te) ===
    packing: bool = False
    dataset_type: str = "custom"
    context_parallel_load_balance: bool = False
