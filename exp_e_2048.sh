#!/bin/bash
#SBATCH --job-name=exp-e-2048
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --mem=0
#SBATCH --time=01:00:00
#SBATCH --output=logs/exp_e_2048_%j.out
#SBATCH --error=logs/exp_e_2048_%j.err
#SBATCH --partition=workq

set -e
echo "============================================================"
echo "Experiment E: n_perturbations=2048 (NO WARMUP)"
echo "============================================================"
...
class Config:
    ...
    task_size: int = 500
    tick_size: int = 100
    checkpoint_dir: str = '/tmp/exp_e_2048'
    checkpoint_every: int = 9999
    seed: int = 42
    output_dir: str = '/tmp/exp_e_2048'

print(f'JAX devices: {jax.devices()}')
print(f'Config: n_perturbations=2048, n_steps=10, n_warmup_msgs=0 (NO WARMUP)')
...
print()
print('============================================================')
print('RESULT: n_perturbations=2048 (NO WARMUP)')
print('============================================================')
...
echo ""
echo "Experiment E 2048 Complete! End: $(date)"
