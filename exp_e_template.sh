#!/bin/bash
#SBATCH --job-name=exp-e-N_PERT_VAL
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --mem=0
#SBATCH --time=01:00:00
#SBATCH --output=logs/exp_e_N_PERT_VAL_%j.out
#SBATCH --error=logs/exp_e_N_PERT_VAL_%j.err
#SBATCH --partition=workq

set -e
echo "============================================================"
echo "Experiment E: n_perturbations=N_PERT_VAL (NO WARMUP)"
echo "============================================================"
...
class Config:
    ...
    lora_rank: int = 4
    grad_clip: float = 1.0
    n_perturbations: int = N_PERT_VAL
    n_epochs: int = 1
    n_steps: int = 10
    ...
    task_size: int = 500
    tick_size: int = 100
    checkpoint_dir: str = '/tmp/exp_e_N_PERT_VAL'
    checkpoint_every: int = 9999
    seed: int = 42
    output_dir: str = '/tmp/exp_e_N_PERT_VAL'

print(f'JAX devices: {jax.devices()}')
print(f'Config: n_perturbations=N_PERT_VAL, n_steps=10, n_warmup_msgs=0 (NO WARMUP)')
...
print()
print('============================================================')
print('RESULT: n_perturbations=N_PERT_VAL (NO WARMUP)')
print('============================================================')
...
echo ""
echo "Experiment E N_PERT_VAL Complete! End: $(date)"
