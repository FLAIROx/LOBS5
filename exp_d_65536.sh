#!/bin/bash
#SBATCH --job-name=exp-d-65536
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --mem=0
#SBATCH --time=01:00:00
#SBATCH --output=logs/exp_d_65536_%j.out
#SBATCH --error=logs/exp_d_65536_%j.err
#SBATCH --partition=workq

set -e
echo "============================================================"
echo "Experiment D: n_perturbations=65536"
echo "============================================================"
...
class Config:
    ...
    task_size: int = 500
    tick_size: int = 100
    checkpoint_dir: str = '/tmp/exp_d_65536'
    checkpoint_every: int = 9999
    seed: int = 42
    output_dir: str = '/tmp/exp_d_65536'

print(f'JAX devices: {jax.devices()}')
print(f'Config: n_perturbations=65536, n_steps=10, background_msgs_per_step=10')
...
print()
print('============================================================')
print('RESULT: n_perturbations=65536')
print('============================================================')
...
echo ""
echo "Experiment D 65536 Complete! End: $(date)"
