...
set -e
echo "============================================================"
echo "ES-LOBS5 Production Training J3 (24h) - task_size=10"
echo "============================================================"
...
mkdir -p logs
mkdir -p checkpoints/es_production_j3
...
class Config:
    ...
    n_epochs: int = 1000
    n_steps: int = 20                # H5 base
    n_warmup_msgs: int = 500
    background_msgs_per_step: int = 100  # H5 base
    token_mode: int = 24
    background_mode: str = 'historical_replay'
    task: str = 'sell'
    task_size: int = 10              # J3: 10 shares to execute
    tick_size: int = 100
...
print(f'Config: J3 (H5 base, task_size=10)')
...
print()
print('='*60)
print('TRAINING COMPLETE (J3: H5 base, task_size=10)')
print('='*60)
