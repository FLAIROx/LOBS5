#!/bin/bash
#SBATCH --job-name=exp-g-64
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --mem=0
#SBATCH --time=01:00:00
#SBATCH --output=logs/exp_g_64_%j.out
#SBATCH --error=logs/exp_g_64_%j.err
#SBATCH --partition=workq

set -e
echo "============================================================"
echo "Experiment G: n_perturbations=64, bg_msgs/step=100"
echo "============================================================"
...
class Config:
    ...
    task_size: int = 500
    tick_size: int = 100
    checkpoint_dir: str = '/tmp/exp_g_64'
    checkpoint_every: int = 9999
    seed: int = 42
    output_dir: str = '/tmp/exp_g_64'

print(f'JAX devices: {jax.devices()}')
print(f'Config: n_perturbations=64, n_steps=10, bg_msgs/step=100, n_warmup_msgs=500')
...
print()
print('============================================================')
print('RESULT: n_perturbations=64, bg_msgs/step=100')
print('============================================================')
...
echo ""
echo "Experiment G 64 Complete! End: $(date)"
