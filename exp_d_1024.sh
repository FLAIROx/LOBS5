#!/bin/bash
#SBATCH --job-name=exp-d-1024
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --mem=0
#SBATCH --time=01:00:00
#SBATCH --output=logs/exp_d_1024_%j.out
#SBATCH --error=logs/exp_d_1024_%j.err
#SBATCH --partition=workq

set -e
echo "============================================================"
echo "Experiment D: n_perturbations=1024"
echo "============================================================"
...
class Config:
    ...
    task_size: int = 500
    tick_size: int = 100
    checkpoint_dir: str = '/tmp/exp_d_1024'
    checkpoint_every: int = 9999
    seed: int = 42
    output_dir: str = '/tmp/exp_d_1024'

print(f'JAX devices: {jax.devices()}')
print(f'Config: n_perturbations=1024, n_steps=10, background_msgs_per_step=10')
...
print()
print('============================================================')
print('RESULT: n_perturbations=1024')
print('============================================================')
...
echo ""
echo "Experiment D 1024 Complete! End: $(date)"
