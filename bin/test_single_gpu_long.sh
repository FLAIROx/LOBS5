#!/bin/bash
#SBATCH --job-name=test_1gpu_long
#SBATCH --output=logs/test_1gpu_long_%j.out
#SBATCH --error=logs/test_1gpu_long_%j.err
#SBATCH --nodes=1
...
echo "========================================"
echo "Single GPU Long Test (BF16 + single optimizer, 3 epochs)"
echo "========================================"
echo "Node: $(hostname)"
echo "Time: $(date)"
echo "========================================"
...
export USE_BF16=1
export USE_SINGLE_OPTIMIZER=1  # Use single AdamW
...
python -u run_train.py \
    ...
    --dt_global=False --epochs=3 --jax_seed=42 \
    ...
    --wandb_project=lobs5-bf16-single-opt-test
