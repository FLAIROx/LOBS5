...
#SBATCH --output=logs/test_4gpu_%j_node%N.log
#SBATCH --error=logs/test_4gpu_%j_node%N.err
#SBATCH --nodes=1
...
echo "========================================"
echo "4 GPU Single Node Test (BF16 + single optimizer)"
echo "========================================"
echo "Node: $(hostname)"
