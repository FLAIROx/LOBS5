#!/bin/bash
#SBATCH --job-name=fp32_test
#SBATCH --output=logs/fp32_test_%j.out
#SBATCH --error=logs/fp32_test_%j.err
#SBATCH --nodes=1
...
echo "========================================"
echo "FP32 Only Test (Disable BF16)"
echo "========================================"
echo "Node: $(hostname)"
echo "Time: $(date)"
echo "========================================"
...
export USE_BF16=0  # Disable BF16, use pure FP32
