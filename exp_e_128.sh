#!/bin/bash
#SBATCH --job-name=exp-e-128
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --mem=0
#SBATCH --time=01:00:00
#SBATCH --output=logs/exp_e_128_%j.out
#SBATCH --error=logs/exp_e_128_%j.err
#SBATCH --partition=workq

set -e
echo "============================================================"
echo "Experiment E: n_perturbations=128 (NO WARMUP)"
echo "============================================================"
...
class Config:
    ...
    task_size: int = 500
    tick_size: int = 100
    checkpoint_dir: str = '/tmp/exp_e_128'
    checkpoint_every: int = 9999
    seed: int = 42
    output_dir: str = '/tmp/exp_e_128'

print(f'JAX devices: {jax.devices()}')
print(f'Config: n_perturbations=128, n_steps=10, n_warmup_msgs=0 (NO WARMUP)')
...
print()
print('============================================================')
print('RESULT: n_perturbations=128 (NO WARMUP)')
print('============================================================')
...
echo ""
echo "Experiment E 128 Complete! End: $(date)"
